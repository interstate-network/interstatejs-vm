...
function getRoot(stateManager) {
    return __awaiter(this, void 0, void 0, function () {
        var newTrie, scratch, cache;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    newTrie = stateManager._wrapped._trie.copy();
                    scratch = level();
                    if (!newTrie._scratch) return [3 /*break*/, 2];
                    return [4 /*yield*/, new Promise(function (resolve, reject) { return newTrie.createScratchReadStream(newTrie._scratch).pipe(WriteStream(scratch)).on('close', function () { return resolve(); }); })];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                    ...
                    stateManager._wrapped._cache._cache.forEach(function (key, value) {
                ...
                case 3:
                    _a.sent();
                    return [2 /*return*/, new ethereumjs_util_1.BN(newTrie._root)];
            }
        });
    });
}
