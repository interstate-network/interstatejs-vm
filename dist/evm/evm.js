...
var EVM = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 7:
                        _a.sent();
                        if (!message.isCompiled) return [3 /*break*/, 9];
                        if (!(err.error === exceptions_1.ERROR.OUT_OF_GAS)) return [3 /*break*/, 9];
                        return [4 /*yield*/, this._touchAccount(message.to)];
                    case 8:
                        _a.sent();
                        _a.label = 9;
    ...
    EVM.prototype._executeCall = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var account, toAccount, stateRootEnter, _a, _b, result, witness_1, stateRootLeave, _c, returnDataHash, witness_2, error;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        ...
                        _d.label = 6;
                    case 6:
                        if (!this._produceWitness) return [3 /*break*/, 8];
                        _b = BN.bind;
                        return [4 /*yield*/, getRoot_1.default(this._state)];
                    case 7:
                        _a = new (_b.apply(BN, [void 0, _d.sent()]))();
                        return [3 /*break*/, 9];
                    case 8:
                        _a = new BN(0);
                        _d.label = 9;
                    ...
                    case 10:
                        ...
                        if (!message.code || message.code.length === 0) {
                            ...
                            if (this._produceWitness) {
                                witness_1 = new message_1.default(stateRootEnter, stateRootEnter, // this is intentional, if no code is executed the enter & exit roots match
                                message.isStatic, new BN(this._tx.origin), new BN(message.caller), new BN(message.to), new BN(message.codeAddress), message.value, new BN(this._tx.gasPrice), message.gasLimit, new BN(0), new BN(0), new BN(ethereumjs_util_1.keccak256(Buffer.alloc(0))), message.data);
                                witness_1.status = message_1.Status.stop;
                                result.witnesses = [witness_1];
                            }
                            return [2 /*return*/, {
                                    gasUsed: new BN(0),
                                    execResult: result,
                        ...
                        return [3 /*break*/, 13];
                    case 11: return [4 /*yield*/, this.runInterpreter(message)];
                    case 12:
                        result = _d.sent();
                        _d.label = 13;
                    case 13:
                        if (!this._produceWitness) return [3 /*break*/, 15];
                        _c = BN.bind;
                        return [4 /*yield*/, getRoot_1.default(result.runState.eei._state)];
                    case 14:
                        stateRootLeave = new (_c.apply(BN, [void 0, _d.sent()]))();
                        returnDataHash = new BN(ethereumjs_util_1.keccak256(result.returnValue.length == 0 ? Buffer.alloc(0) : result.returnValue));
                        witness_2 = new message_1.default(stateRootEnter, stateRootLeave, message.isStatic, new BN(this._tx.origin), new BN(message.caller), new BN(message.to), new BN(message.codeAddress), message.value, new BN(this._tx.gasPrice), message.gasLimit, result.gasUsed, result.gasRefund || new BN(0), returnDataHash, message.data);
                        witness_2.state_access_list = result.runState.state_access_list || [];
                        if (result.exceptionError) {
                            error = result.exceptionError.error;
                            switch (error) {
                                case exceptions_1.ERROR.STOP:
                                    witness_2.status = message_1.Status.stop;
                                    break;
                                case exceptions_1.ERROR.REVERT:
                                    witness_2.status = message_1.Status.revert;
                                    break;
                                default:
                                    witness_2.status = message_1.Status.exception;
                                    break;
                            }
                        }
                        else
                            witness_2.status = message_1.Status.success;
                        result.runState;
                        result.witnesses = __spreadArrays([witness_2], (result.witnesses || []));
                        _d.label = 15;
    ...
    EVM.prototype.runInterpreter = function (message, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var env, _a, eei, interpreter, interpreterRes, result, gasUsed;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = {
                    ...
                    case 2:
                        ...
                        if (interpreterRes.exceptionError) {
                            ...
                            result = __assign(__assign({}, result), { logs: [], gasRefund: new BN(0), selfdestruct: {}, messageWitnesses: [] });
                        }
                        return [2 /*return*/, __assign(__assign({}, result), { runState: __assign(__assign(__assign({}, interpreterRes.runState), result), eei._env), exceptionError: interpreterRes.exceptionError, gas: eei._gasLeft, gasUsed: gasUsed, witnesses: eei._result.messageWitnesses, returnValue: result.returnValue ? result.returnValue : Buffer.alloc(0) })];
                }
            });
        });
    };
